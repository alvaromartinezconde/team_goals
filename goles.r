...
setwd("C:/Users/mcond/OneDrive/Escritorio/Practica_Individual")
...
##########################################
# 2020-21 Atletico Madrid 2 - Sevilla 1
##########################################

## CAMBIAR AQUI POR EL NOMBRE DE FICHERO

### partido 2020-21 Atletico Madrid 2 - Sevilla 1

eventos <- leer_f24("f24-23-2020-2136202-eventdetails.xml")
